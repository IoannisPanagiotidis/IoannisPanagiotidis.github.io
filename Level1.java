...
public class Level1 extends GameLevel{
    ...
    public Level1(Game game){
        ...
        //creat monster level 1
        for (int i = 0; i < 3; i++){
            monster = new Monster(this);
            monster.setPosition(new Vec2(i * 3 + 5, -9));
        }
        ...
        //creat a wooden box level 1
        woodenBox = new WoodenBox(this);
        woodenBox.setPosition(new Vec2(0.1f, -7f));

        heart = new Heart(this);
        heart.setPosition(new Vec2(8, 0));
